...
func init() {
	...
	flags.String("db-user", "", "User to authenticate with the mongodb server")
	flags.String("db-password", "", "Password to authenticate with the mongodb server")
	flags.String("db-rs-tags", "", "Link hostname with tag on mongodb replica set - Optional: hostnameA:tagName:value,hostnameB:tagName:value")
